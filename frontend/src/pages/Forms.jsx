                    ...
                    <div className='flex flex-col p-3 border-b border-gray-300'>
                        ...
                        />
                        {
                            currentUser ?
                                ...
                                <div className='flex items-center justify-center bg-gray-600 py-1 text-white rounded-lg cursor-pointer'><Link to={'/signup'}>SignIn</Link></div>
                        }
                    </div>
                </form>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='flex flex-col p-3 border-b border-gray-300'>
                        ...
                        <div className='p-3'>
                            ...
                            <button
                                type="button"
                                className='m-2 rounded-lg bg-red-600 text-white px-3 py-1 hover:opacity-80 disabled:opacity-80'
                                onClick={createUuid}
                            >
                                Generate
                            </button>
                            <button
                                type="button"
                                className='rounded-lg bg-blue-600 text-white px-3 py-1 hover:opacity-80 disabled:opacity-80 ' disabled={id.length === 0}
